                ...
                <div className="flex flex-col md:flex-row gap-6 justify-between items-center">
                    <div className="flex-1 space-y-5 w-full">
                        <h1 className="header-text max-w-96 tracking-[-0.8px] leading-[32px] md:leading-[64px]">
                            인사담당자 66%<br />
                            특정 직무에 대한 평판조회 필요성 인식
                        </h1>
                        <div className="hidden md:block content-paragraph w-full">
                            인사담당자 705명을 대상으로 한 설문조사에서 66%는 특별히<br className="br-mobile" /> 평판조회를<br className="hidden md:flex" />많이 하는 직무가 있다고 응답하였습니다. 가장 많이 하는 직무 <strong>1위는 재무/회계/<br />경리45%</strong>로 가장 많았습니다.
                            2위는 영업/판매/영업관리로 17%, 3위는 경영<br />기획/인사 15%, 4위는 고객상담/CS/서비스 8% 등입니다.<br />
                            <strong>특정 직무를 평판조회하는 이유로 50%가 직무 특성상 개인의 인성이나 성향이<br />중요하기 때문, 40%는 부적합한 사람을 채용할 경우 사고 발생 가능성이나 파장</strong><br />이 큰 직무이기 때문이라는 응답이었습니다.
                        </div>
                        <div>
                    ...
                    <div className="flex-1 w-full">
                        <img src="/assets/pie-chart-02.png" className="w-full" alt="pie chart" />
                    </div>
                </div>
                <div className="flex flex-col md:flex-row gap-6 justify-between items-center w-full">
                    <div className="flex-1 space-y-5 w-full">
                        ...
                        <div className="content-paragraph">
                            ...
                            <p>3위는 회사의 인재상과 부합하는지 확인하기 위해서 (36.2%) 등입니다.</p>
                        </div>
                    </div>
