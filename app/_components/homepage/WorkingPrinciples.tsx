...
const caseStudies: CaseStudy[] = [
    ...
    },
    {
        ...
        content: (<>서류전형을 통과하기 위한 노력의 일환으로 지원자는 화려한 이력서를 작성합니다. 미국의 취업 사이트 커리어 빌더닷컴이2006년 1000여명의 채용 담당자를 대상으로 조사한 결과를 보면<br/>
            약 57%는 ‘거짓 이력서’를 발견한 경험이 있는 것으로 나타났습니다. 국내 취업 사이트 사람인이2007년 구직자를 대상으로 한 조사에서 학력/경력/특기 등을 과장 또는 허위로 이력서에<br/>
            작성한 경험이 있다는 응답이 약 16%였으며, 합격하기 위해 거짓말을 할 의사가 있다는 응답이 약 54%나 되었습니다. <strong>평판 조회는 지원자가 실제로 조직과 업무에 기여했던 방식과 동료 및<br/>
                상사와의 관계를 구체적으로 확인할 수 있는 객관적인 방법입니다.</strong></>),
        backgroundImage: 'card2.jpeg',
    },
    {
        id: 3,
        title: <p><strong>면접의 달인 등장,</strong><br />실제 역량 검증 필요<br/></p>,
        content: (<>업무에서의 실제 성과, 팀워크, 리더십, 문제 해결 능력 등은 서류와 인터뷰만으로 완전히<br/>
            검증하기 어렵습니다. 구직자들의 면접 스킬은 날로 발전하고 있습니다. 서점에는 면접 성공<br/>
            비결에 관한 책들이 많이 출판되었고, 다양한 온라인 카페와 블로그에서는 면접 노하우를<br/>
            공유하며, 구직자들은 수차례 모의면접을 진행하여 실력을 다지고 있습니다. 이러한 변화에<br/>
            발맞춰 구직자들의 면접 준비는 점점 더 세련되고 철저해지고 있습니다. 하지만 문제는<br/>
            면접에서 나타나는 화려한 이력과 자신감 넘치는 대답만으로는 지원자가 실제로 업무에<br/>
    ...
    },
    {
        ...
        content: (<>중요한 직책의 경우, 신뢰할 수 없는 사람을 채용하면 기업 이미지와 평판에 직접적인 영향을<br/>
            미칠 수 있습니다. 또한, 과거의 문제 행동(예: 윤리적 이슈, 업무 태만 등)이 반복될 가능성을<br/>
            미리 차단할 수 있습니다. <strong>평판 조회는 기업이 윤리적이고 책임감 있는 결정을 내리는데<br/>
