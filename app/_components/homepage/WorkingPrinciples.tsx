...
const caseStudies: CaseStudy[] = [
    {
        ...
        content: (
            <>
                ...
                연봉의 1.5배 이상, 임원은 최대 24배가량으로 파악되었습니다.<strong> 평판조회는 이러한 리스크를
    ...
    },
    {
        ...
        content: (<>서류전형을 통과하기 위한 노력의 일환으로 지원자는 화려한 이력서를 작성합니다. 미국의 취업 사이트 커리어 빌더닷컴이 2006년 1000여 명의 채용 담당자를 대상으로 조사한 결과를 보면
            약 57%는 ‘거짓 이력서’를 발견한 경험이 있는 것으로 나타났습니다. 국내 취업 사이트 사람인이 2007년 구직자를 대상으로 한 조사에서 학력/경력/특기 등을 과장 또는 허위로 이력서에
            작성한 경험이 있다는 응답이 약 16%였으며, 합격하기 위해 거짓말을 할 의사가 있다는 응답이 약 54%나 되었습니다. <strong>평판조회는 지원자가 실제로 조직과 업무에 기여했던 방식과 동료 및
    ...
    },
    {
        ...
        content: (<>업무에서의 실제 성과, 팀워크, 리더십, 문제 해결 능력 등은 서류와 인터뷰만으로 완전히
            ...
            적합한지, 그리고 과거에 어떻게 행동했는지 파악하기 어렵습니다.<strong> 이러한 문제를 해결하고 보다 신뢰성 있는 채용을 진행하기 위해 평판조회가 필요합니다.</strong></>),
    ...
    },
    {
        ...
        content: (<>중요한 직책의 경우, 신뢰할 수 없는 사람을 채용하면 기업 이미지와 평판에 직접적인 영향을
            ...
            미리 차단할 수 있습니다. <strong>평판조회는 기업이 윤리적이고 책임감 있는 결정을 내리는데
