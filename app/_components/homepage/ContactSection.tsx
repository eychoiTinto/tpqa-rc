    ...
    return (
        <div className="bg-[#0A2844] text-muted-foreground py-[120px] md:py-40 px-5 md:px-0">
            <div className="container mx-auto">
                {/* Header */}
                <div className="mb-10 md:mb-[60px] space-y-3 md:space-y-4">
                    <img src="logo.svg" alt="refercheck logo" className="h-3 md:h-6" />
                    <h1 className="text-xl md:text-[40px] font-medium mb-4 tracking-[-0.8px]">Contact Consulting</h1>
                    <p className="hidden md:block text-muted-foreground text-sm md:text-xl leading-relaxed">
                        <strong>회사소개서(고객사 포함), 평판조회 샘플은 아래 양식으로 요청해주세요.</strong>
                        <br />
                        <span>아래 양식에 문의 내용을 남겨주시면 확인 후 회신드리도록 하겠습니다.</span>
                    </p>
                    <p className="block md:hidden text-muted-foreground text-sm md:text-xl leading-relaxed">
                    ...
                    <CardContent className="p-0">
                        <form className="space-y-6">
                            ...
                            <div className="hidden md:flex justify-end">
                                <Button className="bg-white text-[#051C2E] text-lg hover:bg-gray-100 rounded-full py-7 px-7">Send Message</Button>
                            </div>
                        </form>
                    </CardContent>
                </Card>
