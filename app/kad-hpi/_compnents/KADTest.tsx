        ...
        <div className='px-5 md:px-0'>
            <div className='container space-y-4 md:space-y-3 mt-[60px] md:mt-[100px]'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-10 pb-14'>
                    ...
                    <div onClick={() => setIsExpanded(!isExpanded)} className={`rounded-2xl p-4 md:p-8 space-y-2 text-primary border ${isExpanded && 'border-[#1C4A90]'} hover:border-[#1C4A90] hover:bg-[#1c4a900a] hover:cursor-pointer`}>
                ...
                {
                    isExpanded && <div className='pb-[120px] md:pb-[160px]'>
