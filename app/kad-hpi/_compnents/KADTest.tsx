	                    ...
	                    <table className="w-full text-sm md:text-lg text-primary tracking-[-0.28px]">
	                        <thead>
	                            <tr className="bg-gray-50">
	                                <th className="py-3 px-4 text-center font-medium min-w-[100px] md:min-w-[200px]">검사유형</th>
	                                <th className="py-3 px-4 text-center font-medium min-w-[880px] md:min-w-full">검사항목</th>
	                                <th className="py-3 px-4 font-medium min-w-[200px]">항목수</th>
	                                <th className="py-3 px-4 text-center font-medium min-w-[200px]">문항수</th>
	                            </tr>
	                        </thead>
	                        <tbody>
	                            <tr>
	                                <td className="border-t py-3 px-4 text-center">인성</td>
	                                ...
	                                <td rowSpan={3} className="border-l border-t py-3 px-4">
	                                    <div>
	                            ...
	                            <tr>
	                                <td className="border-t py-3 px-4 text-center">직무능력</td>
	                            ...
	                            <tr>
	                                <td className="border-t py-3 px-4 text-center">적응적성</td>
	                                <td className="border-t border-l py-3 px-4">사무(기획, 총무, 회계, 안내), 영업(영업, 마케팅, 홍보, 무역), 기술(전산(IT), 연구개발, 생산관리, 기능직), 전문직(언론, 교육, 법무, 금융)</td>
	                                <td>
