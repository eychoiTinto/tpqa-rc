                ...
                <table className="w-full text-sm md:text-lg text-primary tracking-[-0.28px] md:tracking-[0.36px] ">
                    <thead>
                        <tr className="bg-gray-50">
                            <th className="text-primary py-3 px-4 text-center font-medium min-w-[100px] md:min-w-[200px]">구분</th>
                            <th className="text-primary py-3 px-4 text-center font-medium min-w-[880px]">검사항목</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td className="border-t py-3 px-4 text-center">공영기업</td>
                            <td className="border-t border-l py-3 px-4">
