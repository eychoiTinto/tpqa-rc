                    ...
                    <div className='flex flex-col justify-between gap-10 w-full'>
                        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-6 w-full'>
                            ...
                            <div className='card-no-border basis-2/3 w-full'>
                                ...
                                <p className='card-description !leading-[25px] md:!leading-[36px]'>짧은 면접 시간과 서류만으로는 지원자의 숨겨진 성과와 역량을 완전히 파악하기 어렵습니다.<br />
                        ...
                        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-3'>
                            ...
                            <div className='card-no-border basis-2/3'>
                                ...
                                <p className='card-description !leading-[25px] md:!leading-[36px]'>상사/동료/부하직원과의 인간관계를 확인하여, 입사 후 조직에 미칠 영향을 평가합니다. 이를 통해<br />
                        ...
                        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-3'>
                            ...
                            <div className='card-no-border basis-2/3'>
                                ...
                                <p className='card-description !leading-[25px] md:!leading-[36px]'>퇴직 이유에 징계 또는 부적절한 행위가 포함되었는지 검토합니다. 이를 통해 지원자의 준법성, 근면성,<br />
