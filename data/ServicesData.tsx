...
export const servicesData: ServicesDataTypes[] = [
    ...
    },
    {
        ...
        "description": <>
            ...
            <ul className={ulStyles}><li>전직장 근무기간, 직위,<br className="hidden md:block" />프로젝트 수행 이력 등</li></ul>
        </>,
        "status": "닫기"
    },
    {
        ...
        "description": <><p><strong>서류에 작성된 내용의 허위/과장/누락 여부</strong></p>
            <ul className={ulStyles}>
                <li>전직장 근무기간, 직위, 프로젝트 수행 이력 등</li>
                <li>전직장 업무 성과 및 그 과정에서의 개인적 공헌 포인트</li>
    ...
    },
    {
        ...
        "description": <>
            <ol className={olStyles}>
                ...
                <li>리더십(조직관리역량, 책임감 등 리더로서 필요한 자질)</li>
            </ol>
        </>,
        "status": "닫기"
    }
